				...
				<div class="col-sm-12">
					<form:form commandName="join" cssClass="md-float-material form-material">
						<div class="text-center">
							<a href="<c:url value="/m" />"><img src="<c:url value="/resources/images/basic-logo.png" />" alt="logo.png"></a>
						</div>
						<div class="auth-box card">
							<div class="card-block">
								...
								<div class="form-group form-primary">
									...
									<div id="emailWarning" class="col-form-label text-danger d-none" style="font-size: 12px;">이미 등록된 이메일입니다.</div>
								</div>
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group form-primary">
								...
								<div class="form-group form-primary">
									<form:input path="recommanderemail" cssClass="form-control" /> <span class="form-bar"></span> <label class="float-label text-pink">추천인 이메일을 입력해 주십시오.</label>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<p class="text-inverse text-left">
											<a href="<c:url value="/m" />"><b>메인페이지로</b></a>
										</p>
									</div>
									<!-- <div class="col-md-2">
