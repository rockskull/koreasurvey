										...
										<div class="form-group row">
											...
											<div class="col-sm-2">
												<div class="input-group input-group-button mb-0">
													<div class="input-group-prepend"><button id="costMinus" class="btn btn-primary" type="button" disabled="disabled"><i class="fa fa-minus"></i></button></div>
													<input type="text" class="form-control" id="unitcost" name="unitcost" readonly="readonly" value="0" />
											...
											<div class="m-0 question-edit">
												<div class="card">
															...
															<div class="col-12">
																...
																<div class="row form-group">
																	...
																	<div class="col-sm-10 input-group input-group-button">
																		<input type="text" class="form-control form-control-primary option-value" placeholder="선택 문항을 입력하십시오.">
													...
													<div class="card-footer text-center">
														...
														<button type="button" class="btn btn-round question-delete"><i class="fa fa-times"></i> 현재 문항 삭제</button>
													</div>
												</div>
											</div>
...
$(function() {
	...
	$("#save").click(function() {
		...
		$.post("saveSurveyDoc", {strObject : strObject}, function(id) {
			alert("저장되었습니다.");
	...
	$("#addQuestion").click(function() {
		$.get("<c:url value="/resources/import.txt" />", function(result) {
			...
			$(".del-card, .question-delete").unbind();
			$(".del-card, .question-delete").click(function() {
