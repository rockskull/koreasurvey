						...
						<div class="auth-box card">
							<div class="card-block">
								...
								<div class="row m-t-25 text-left">
									<div class="col-12">
										...
										<div class="forgot-phone text-right float-right">
											<a href="<c:url value="/m/account/findPassword" />" class="text-right f-w-600">패스워드 찾기</a>
										</div>
									</div>
								</div>
								<div class="row m-t-30">
									...
									<p class="text-inverse text-left">계정이 없으신가요? 지금 <a href="<c:url value="/m/account/join" />" class="text-primary"><strong>가입 </strong></a>하세요!</p>
							</div>
						</div>
					</form>
						<%-- <div class="text-center">
