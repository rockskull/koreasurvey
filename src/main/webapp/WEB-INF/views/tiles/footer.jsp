	...
	<div class="footer-menu-bar z-depth-top-0" style="position: fixed; height: 50px; width: 100%; bottom: 0px; background-color: white;padding: 10px; z-index: 10;">
		<div class="row text-center">
			<c:if test="${empty sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal }">
				<a href="<c:url value="/m" />" class="col">
					<i class="ti-home f-16"></i>
					<div class="f-10">홈</div>
				</a>
				<a href="#" class="col">
					<i class="ti-comments f-16"></i>
					<div class="f-10">게시판</div>
				</a>
				<a href="<c:url value="/m/account/login" />" class="col">
					<i class="ti-write f-16"></i><br />
					<div class="f-10">내 설문 관리</div>
				</a>
				<a href="<c:url value="/m/account/login" />" class="col">
			...
			<c:if test="${not empty sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal }">
				...
				<a href="<c:url value="/m/board" />" class="col">
					<i class="ti-comments f-16"></i>
					<div class="f-10">게시판</div>
				</a>
				<a href="<c:url value="/m/account/surveys" />" class="col">
					<i class="ti-write f-16"></i><br />
					<div class="f-10">내 설문 관리</div>
				</a>
				
				<a href="<c:url value="/m/account" />" class="col">
					<i class="ti-user f-16"></i><br />
					<div class="f-10">내 정보</div>
				</a>
			</c:if>
...
<c:if test="${definition eq 'boardList'}">
	<script type="text/javascript" src="<c:url value="/resources/js/stroll.js" />"></script>
	<script type="text/javascript" src="<c:url value="/resources/js/list-custom.js" />"></script>
</c:if>
