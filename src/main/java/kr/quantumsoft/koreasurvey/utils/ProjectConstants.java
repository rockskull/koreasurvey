...
public class ProjectConstants {
	public static final Double MY_POINT_RATE = 5.0;
	public static final Double FIRST_PARENT_POINT_RATE = 3.0;
	public static final Double SECOND_PARENT_POINT_RATE = 2.0;
	...
	public static final Integer TRADING_SUBMIT_DIVIDEND = 3;
	public static final Integer TRADING_RECOMMEND = 4;
	public static final Integer TRADING_JOIN = 5;
	public static final Integer TRADING_JOIN_DIVIDEND = 6;
	...
	public static final String UPLOAD_PATH = (System.getProperty("os.name").toLowerCase().indexOf("win") >= 0) ? "D:\\temp\\" : "/tmp/";
}
