								...
								<div class="card-block">
									...
									<div id="doc">
										...
										<div class="form-group row">
											...
											<div class="col-sm-2">
												<input type="text" class="form-control" id="unitcost" name="unitcost" value="${survey.unitcost }" />
											</div>
										</div>
										<div class="form-group row">
									...
									<div id="listQuestion">
										...
										<div class="item">
											...
											<div class="m-0 question-edit d-none">
												<div class="card">
													<div class="card-block">
														<div class="row">
															<div class="col-sm-4">
															...
															<div class="col-12">
																<div class="row form-group">
																	...
																	<div class="col-sm-10 input-group input-group-button">
																		<input type="text" class="form-control form-control-primary" placeholder="선택 문항을 입력하십시오." value="${option.option }" />
